...
function regAndroidPushToken(token) {
  utility.writeCookie("ANDROID_PUSH_TOKEN", token, 99999);
}

function regIosPushToken(token) {
  utility.writeCookie("IOS_PUSH_TOKEN", token, 99999);
}